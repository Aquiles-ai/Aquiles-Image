...
class CreateImageRequest(BaseModel):
    ...
    quality: Optional[Literal["standard", "hd", "low", "medium", "high", "auto"]] = Field(description="The quality of the image that will be generated.")
    ...
    size: Optional[Literal["auto", "1024x1024", "1536x1024", "1024x1536", "256x256", "512x512", "1792x1024", "1024x1792", "2048x2048"]] = Field(description="The size of the generated images.")
...
class CreateImageEditRequest(BaseModel):
    ...
    size: Optional[Literal["256x256", "512x512", "1024x1024", "1536x1024", "1024x1536", "1792x1024", "1024x1792", "auto"]] = Field(description="The size of the generated images. Must be one of `1024x1024`, `1536x1024` (landscape), `1024x1536` (portrait), or `auto` (default value)")
    ...
    quality: Optional[Literal["standard", "low", "medium", "high", "auto"]] = Field(description="The quality of the image that will be generated.")
