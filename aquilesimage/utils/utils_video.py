...
def download_tokenizers():
    hf_hub_download(repo_id="lightx2v/Encoders", filename="special_tokens_map.json", subfolder="google/umt5-xxl", local_dir=f"{AQUILES_VIDEO_BASE_PATH}/wan_2_2/wan2.2_ti2v_lightx2v.safetensors/google/umt5-xxl/.cache/huggingface")
    hf_hub_download(repo_id="lightx2v/Encoders", filename="spiece.model", subfolder="google/umt5-xxl", local_dir=f"{AQUILES_VIDEO_BASE_PATH}/wan_2_2/wan2.2_ti2v_lightx2v.safetensors/google/umt5-xxl/.cache/huggingface")
    hf_hub_download(repo_id="lightx2v/Encoders", filename="tokenizer.json", subfolder="google/umt5-xxl", local_dir=f"{AQUILES_VIDEO_BASE_PATH}/wan_2_2/wan2.2_ti2v_lightx2v.safetensors/google/umt5-xxl/.cache/huggingface")
    hf_hub_download(repo_id="lightx2v/Encoders", filename="tokenizer_config.json", subfolder="google/umt5-xxl", local_dir=f"{AQUILES_VIDEO_BASE_PATH}/wan_2_2/wan2.2_ti2v_lightx2v.safetensors/google/umt5-xxl/.cache/huggingface")
...
def get_tokenizer_path():
    return f"{AQUILES_VIDEO_BASE_PATH}/wan_2_2/google/umt5-xxl"
