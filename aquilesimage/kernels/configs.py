# from https://github.com/huggingface/diffusers/blob/main/src/diffusers/configuration_utils.py
...
from diffusers.utils.constants import HUGGINGFACE_CO_RESOLVE_ENDPOINT
